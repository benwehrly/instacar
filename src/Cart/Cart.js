  ...
  return (
    <div
      ...
      style={{
        ...
        left: isMobile && cartIsOpen ? "0" : cartIsOpen ? "-90vw" : null,
        width: isMobile && "100vw",
        transform: isMobile && cartIsOpen && "translate(0)"
      }}
    >
      <h1 className="cartTitle">Cart</h1>
      <div onClick={() => setCartIsOpen(false)} className="closeCart">
        x
      </div>
      {cart.length ? (
      ...
      {cart.length > 0 && (
        <div className="checkout">
          ...
          <h3 className="total">
            Total: ${(total + fees + tax).toLocaleString("en-US")}
          </h3>
...
const CartItem = ({
  ...
  return (
    <div className="cartItem" style={{ width: isMobile && cartIsOpen && '80vw'}}>
